...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        // TODO - fill in body
        int addValue = key.hashCode();
        this.hashTable[mod(addValue, this.hashTable.length)].add(key, value);
        this.size++;
    }
    ...
    public final Pair<K, V> remove(K key) {
        ...
        // TODO - fill in body
        int hash = mod(key.hashCode(), this.hashTable.length);
        Pair<K, V> removeValue = this.hashTable[hash].remove(key);
        this.size--;
        // This line added just to make the component compilable.
        return removeValue;
    }
    ...
    public final Pair<K, V> removeAny() {
        ...
        Pair<K, V> removeValue = this.hashTable[i].removeAny();
        this.size--;
        // This line added just to make the component compilable.
        return removeValue;
    }
    ...
    public final V value(K key) {
        ...
        // TODO - fill in body
        int value = mod(key.hashCode(), this.hashTable.length);
        // This line added just to make the component compilable.
        return this.hashTable[value].value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        // TODO - fill in body
        int hasKey = mod(key.hashCode(), this.hashTable.length);
        // This line added just to make the component compilable.
        return this.hashTable[hasKey].hasKey(key);
    }
