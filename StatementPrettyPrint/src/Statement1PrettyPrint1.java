    ...
    public void prettyPrint(SimpleWriter out, int offset) {
        ...
        switch (this.kind()) {
            case BLOCK: {
                ...
                // TODO - fill in case
                int blockLength = this.lengthOfBlock();
            ...
            case IF: {
                ...
                String stringCondition = toStringCondition(c);
                printSpaces(out, offset);
                out.println("IF " + stringCondition + " THEN");
                s.prettyPrint(out, (offset + indent));
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIf(c, s);
                break;
            ...
            case IF_ELSE: {
                ...
                // TODO - fill in case
                Statement ifBody = this.newInstance();
                Statement elseBody = this.newInstance();
                Condition c = this.disassembleIfElse(ifBody, elseBody);
                String condStr = toStringCondition(c);
                printSpaces(out, offset);
                out.println("IF " + condStr + " THEN");
                ifBody.prettyPrint(out, (offset + indent));
                printSpaces(out, offset);
                out.println("ELSE");
                elseBody.prettyPrint(out, (offset + indent));
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIfElse(c, ifBody, elseBody);
                break;
            }
            case WHILE: {
